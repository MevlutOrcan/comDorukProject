...
public class SeleniumGridChrome extends TestBaseRapor {

WebDriver driver;
    @Test
    public void gridChromeLogin() throws MalformedURLException, InterruptedException {
        extentTest = extentReports.createTest("Selenium Grid CrossBrowser Chrome Tests",
                "User logs in to the app with valid ID and valid Password");
        driver= new RemoteWebDriver(new URL("http://192.168.56.1:4444"),new ChromeOptions());
